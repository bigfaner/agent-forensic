...
Read each record file from `docs/features/agent-forensic/tasks/records/` whose filename starts with `1.` and does NOT contain `.summary`. Exclude the phase summary's own prior record if one exists.
...
- All phase task records: `docs/features/agent-forensic/tasks/records/1.*.md`
- Design reference: `docs/features/agent-forensic/design/tech-design.md` (Data Models section)
