...
- `docs/features/agent-forensic/prd/prd-spec.md` — Source for business rules
- `docs/features/agent-forensic/prd/prd-user-stories.md` — Source for business context
- `docs/features/agent-forensic/design/tech-design.md` — Source for technical specs

## Acceptance Criteria

- [ ] `docs/features/agent-forensic/specs/biz-specs.md` exists with extracted business rules
- [ ] `docs/features/agent-forensic/specs/tech-specs.md` exists with extracted technical specs
- [ ] If any `[CROSS]` items exist: `docs/features/agent-forensic/specs/review-choices.md` exists with user's approved/rejected items
- [ ] If integration occurred: only items marked "approved" in review-choices.md were integrated to project-level dirs
- [ ] `docs/features/agent-forensic/specs/.integrated` marker exists (with counts if integration occurred, or "skipped: all local" if early exit)
...
- `docs/features/agent-forensic/prd/prd-spec.md`
- `docs/features/agent-forensic/design/tech-design.md`

If missing, mark task `blocked` and stop.

Check idempotency: if `docs/features/agent-forensic/specs/.integrated` exists, skip (already done).

**Step 2: Extract and classify**

Run `/consolidate-specs` skill. The skill will:
- Read all feature documents
- Extract business rules into `docs/features/agent-forensic/specs/biz-specs.md`
- Extract technical specs into `docs/features/agent-forensic/specs/tech-specs.md`
...
Write `docs/features/agent-forensic/specs/.integrated` marker with integrated counts.
